...
filename = ['7MJNMove_Markers-edf.mat'] %Converted data filename
...
filename = ['7MJNMove_Markers-edf.mat'] %Data files
...
if strcmp(trialType, 'Faces')
    ...
    for ii = 1:nTrials_Face
        ...
        savename = ['Sae_faces_aEBfspmeeg_7MJN_' num2str(epochTimeWindow(1)) 'to' ...
...
elseif strcmp(trialType, 'Random')
    ...
    for ii = 1:nTrials_Random
        ...
        savename = ['Sae_random_aEBfspmeeg_7MJN_' num2str(epochTimeWindow(1)) 'to' ...
            num2str(epochTimeWindow(2)) 'ms_trial_' num2str(ii) '.mat']
