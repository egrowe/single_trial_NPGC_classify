...
for reps = 1:nReps
    ...
    figure(1); subplot(4,4,reps); bar(sort(randTrials_F(1:trainSplit)),repmat(10,length((randTrials_F(1:trainSplit))),1)');
   ...
   %Partition the RANDOM data randomly (randmomise trial order)
    ...
    figure(2); subplot(4,4,reps); bar(sort(randTrials_R(1:trainSplit)),repmat(10,length((randTrials_R(1:trainSplit))),1)');
