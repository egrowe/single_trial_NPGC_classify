...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load([filepath 'fmSae_' num2str(trials{1}) '_fspmeeg_P0291_0to500_trial_1.mat'])
...
for jj = 1:length(coordList)
    ...
    filename = ['fmSae_' num2str(trials{1}) '_fspmeeg_P0291_0to500_trial_1.mat']; % set filena,e
...
for jj = 1:length(coordList)
    ...
    for ii = 1:nTrials
        ...
        filename = ['fmSae_' num2str(trials{1}) '_fspmeeg_P0291_0to500ms_trial_' num2str(ii) '.mat']; % set filena,e
