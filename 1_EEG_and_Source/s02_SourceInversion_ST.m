...
filenameFaces = ['fmSae_' num2str(trialType) '_fspmeeg_P0291_' num2str(epochTimeWindow(1)) ...
    'to' num2str(epochTimeWindow(2)) '_trial_' num2str(ii) '.mat']; % filename for FACE trials
filenameRandom = ['fmSae_' num2str(trialType) '_fspmeeg_P0291_' num2str(epochTimeWindow(1)) ...
...
load('badFaceTrials_P0291_Move_Markers-edf.mat'); %load which 'bad' face trials to skip
load('badRandomTrials_P0291_Move_Markers-edf.mat'); %load which 'bad' random trials to skip
